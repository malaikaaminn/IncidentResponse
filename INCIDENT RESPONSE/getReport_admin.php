...
<html>
<head>
<button id="back" style="background-color: "><a href="home_admin.php" style="color:">Back</a></button><div style="margin-top:10px; style : center" >
...
<br>
<br>
<form action="/View_Report_admin.php" method="get">
